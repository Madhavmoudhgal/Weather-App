...
const WeatherApp = () => {
  ...
  const search= async()=>{
    ...
    let url =`https://api.openweathermap.org/data/2.5/weather?q=${element[0].value}&units=Metric&appid=${api_key}`//using tempplate literals we can use the current location which user gives
